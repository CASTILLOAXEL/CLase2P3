...
// double pronostico; E calcularPronostico(demanda, periodo, valorx: 10);
...
////iterar en cada elemonto
//        System.out println StreamPeriodo.forEach((element) -> (
//            System.out println("mes=" + element + " Pronostico:" + Math.round(calcularPronostico(demanda, periodo, elementp));
//｝）；
//        ("Pronostico mes 10:" + pronostico);
    }
